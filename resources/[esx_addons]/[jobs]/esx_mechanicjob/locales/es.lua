Locales['es'] = {
  ...
  ['must_in_flatbed']           = 'Debes estar en una plataforma para realizar la acción',
  ...
  ['not_enough_repair_tools']   = 'No tienes suficientes herramientas para reparar.',
  ['assembling_repair_kit']     = 'Montando Kit de reparación...',
  ['not_enough_body_tools']     = 'No tienes suficientes herramientas de carrocería.',
